...
INSERT INTO scan (is_available,apartment_id, mc_liter)
VALUES (TRUE,1 ,100);
...
INSERT INTO technician (is_available, role, name, surname, username, password)
VALUES (TRUE, 3, 'Edwar', 'Azzaro', 'hacker', '123456ee!');
