...
insert into technician(is_available, role, name, surname, username, password) values (true, 3, 'Carlos', 'Alberto', 'hacker2', '123456ee!');
insert into secretary(is_available, role, name, surname, username, password) values (true, 2, 'Giulia', 'Bianchi', 'Giu99', 'giu_99_00');
insert into intervention(is_available, intervention_date, status, type, apartment_id, secretary_id, technician_id) values (true, '2023-12-17', 3, 0, 1, 1, 1);
insert into intervention(is_available, intervention_date, status, type, apartment_id, secretary_id, technician_id) values (true, '2023-12-17', 3, 1, 2, 1, 1);
insert into intervention(is_available, intervention_date, status, type, apartment_id, secretary_id, technician_id) values (true, '2023-12-17', 3, 0, 1, 1, 1);
insert into intervention(is_available, intervention_date, status, type, apartment_id, secretary_id, technician_id) values (true, '2023-12-17', 3, 0, 2, 1, 1);
insert into intervention(is_available, intervention_date, status, type, apartment_id, secretary_id, technician_id) values (true, '2023-12-17', 3, 0, 2, 1, 1);