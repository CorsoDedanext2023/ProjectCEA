...
public class ApartmentMapper {
	public ApartmentDto toDto(Apartment a) {
		if (a == null)throw new DatiNonValidiException("Apartment is empty: "+a);
		ApartmentDto apart = new ApartmentDto();
		//Da implementare
		return apart;
	}
	public List<ApartmentDto> toListDto(List<Apartment> apart){
		if (apart == null || apart.isEmpty())throw new DatiNonValidiException("List of apartments is empty: "+apart);
